...
//Hint: use d3.scaleBand for xScaleBar
    ...
    const handleMouseEnter = (station, event, pointData) => {
    ...
    const handleMouseOut = () => {setHoveredStation(null);
        setTooltipX(null);
        setTooltipY(null);
    ...
    return (
        <Container >
            ...
            <Row className='justify-content-md-center'>
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        ...
                        height={innerHeightScatter} width={innerWidth} hoveredStation={hoveredStation} onMouseEnter={handleMouseEnter} onMouseOut={handleMouseOut}/>
                    </svg>
                </Col>
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        <BarChart offsetX={margin.left} offsetY={margin.top} data={data} xScale={xScaleBar} 
                        yScale={yScaleBar} height={innerHeightBar} width={innerWidth} hoveredStation={hoveredStation} onMouseEnter={handleMouseEnter} onMouseOut={handleMouseOut}/>
                    </svg>
                </Col>
            </Row>
            ...
            */}
            <Tooltip d={hoveredPoint} x={tooltipX} y={tooltipY} />
        </Container>
    )   
}
